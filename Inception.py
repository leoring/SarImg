...
This is training code based on Inception (GoogleNet).
"""
...
# to train
model = tflearn.DNN(network, checkpoint_path='model_googlenet_sar',
...
model.fit(X, Y, n_epoch=FLAGS.nepoch, validation_set=(testX,testY), shuffle=True,
          ...
          snapshot_epoch=False, run_id='googlenet_sar')

model.save('model_goolgenet_sar')
